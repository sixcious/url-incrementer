...
In order to update URLI to Manifest V3 (MV3), I had to increae the permissions level to `<all_urls>`. Please see this [GitHub Issue](https://github.com/sixcious/url-incrementer/issues/17) for more information and the reasons why. I deeply apologize for the inconvenience.
