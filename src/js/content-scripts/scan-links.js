...
console.log("scan-links.js start");
var URLNP = URLNP || {}; // JavaScript Revealing Module Pattern

/**
 * TODO
 */ 
URLNP.ScanLinks = URLNP.ScanLinks || function() {

	console.log("function URLNP.ScanLinks");
...
*/
	var next, // next, forward
	    prev, // prev, back, previous
	    foundNextPriority = 10,
	...
	function (request, sender, sendResponse) {
		...
		switch (request.greeting) {
			...
			case "getScannedNextAndPrev":
				...
				var links = U.getScannedNextAndPrev();
