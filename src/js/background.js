...
URLI.Background = function () {
  ...
  const STORAGE_DEFAULT_VALUES = {
    ...
    /* keywords */    "nextPrevKeywordsNext": ["next page", "next", "forward", "次", "&gt;", ">", "newer"], "nextPrevKeywordsPrev": ["previous page", "prev", "previous", "前", "&lt;", "<", "‹", "back", "older"], "nextPrevStartsWithExcludes": ["&gt;", ">", "new", "&lt;", "<", "‹", "back", "old"],
